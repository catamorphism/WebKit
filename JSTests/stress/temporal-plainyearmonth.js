...
shouldBe(Temporal.PlainYearMonth.prototype.subtract.length, 1);
{
    ...
    shouldThrow(() => yearMonth.add({ days: 36500000 }), RangeError);
    shouldThrow(() => yearMonth.add(new Temporal.Duration(-1, -1, 0, -1)), RangeError);
    ...
    shouldThrow(() => yearMonth.subtract({ days: 36500000 }), RangeError);
    shouldThrow(() => yearMonth.subtract(new Temporal.Duration(-1, -1, 0, -1)), RangeError);
